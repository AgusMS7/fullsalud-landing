  ...
  const benefits = [
    {
      ...
      description:
        "Reduce el ausentismo con recordatorios inteligentes a tus pacientes.",
    },
    {
      icon: FileText,
      title: "Recetas digitales",
      description:
        "Sin errores, sin confusiones. Prescripción electrónica simple y segura.",
    },
    {
      icon: MessageSquare,
    ...
    },
    {
      ...
      description:
        "No pierdas tiempo. El sistema libera y reasigna turnos automáticamente.",
    },
    {
      icon: UserCheck,
      title: "Acceso para asistentes o secretarías",
      description:
        "Delega tareas administrativas sin perder el control de tu agenda.",
    },
    {
      icon: Activity,
      title: "Gestión inteligente postconsulta",
      description:
        "Automatizá el seguimiento y retené a tus pacientes en tu cartera, sin importar dónde los atendiste.",
    },
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden min-h-[90vh] flex items-center bg-[#022c32]">
        ...
        <div
          ...
          style={{ backgroundColor: "hsl(180 80% 12% / 0.15)" }}
        />
        ...
        <div className="container mx-auto px-6 relative z-10 py-20">
          <div className="max-w-5xl mx-auto text-center text-white">
            ...
            <p className="text-lg md:text-xl lg:text-2xl mb-4 font-medium leading-relaxed max-w-3xl mx-auto">
              Potenciá tu consulta con herramientas digitales inteligentes.
              <br />
              Automatizá tareas, mejorá tu comunicación y hacé crecer tu cartera
              de pacientes.
            </p>

            {/* Microcopy de refuerzo */}
            <p className="text-sm md:text-base lg:text-lg mb-10 opacity-90 max-w-2xl mx-auto">
              Más de 150 médicos ya están aumentando sus consultas con Full
              Salud.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
              ...
              <Button
                size="lg"
                variant="default"
                className="text-xl md:text-2xl px-12 md:px-16 py-7 md:py-9 font-bold shadow-xl transition-all hover:scale-105"
              >
            ...
            <div className="flex justify-center">
              <div className="bg-white/10 backdrop-blur-md border-2 border-white/30 rounded-full px-8 py-4 shadow-2xl">
                <p className="text-sm md:text-base font-semibold inline-flex flex-wrap items-center justify-center gap-2 text-white">
                  ...
                  Apertura de cupos hasta el{" "}
                  <span className="font-bold">15 de noviembre</span> o{" "}
                  <span className="font-bold">350 médicos</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Automatización inteligente para que te enfoques en lo que más
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {benefits.map((benefit, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="p-6 bg-white border border-[hsl(var(--fullsalud-teal))]/20 hover:border-[hsl(var(--fullsalud-teal))]/50 hover:shadow-lg transition-all duration-300"
                >
      ...
      <section className="py-20 bg-gradient-to-br from-secondary/5 via-white to-primary/5">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Descubrí cómo Full Salud está transformando la práctica médica de
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="text-center p-8 bg-white border border-[hsl(var(--fullsalud-teal))]/20 hover:border-[hsl(var(--fullsalud-teal))]/50 transition-all duration-300 hover:shadow-lg">
              <div className="mb-6">
                <span className="text-6xl font-bold text-[hsl(var(--fullsalud-teal))]">
                  1
                </span>
              </div>
            ...
            <Card className="text-center p-8 bg-white border border-[hsl(var(--fullsalud-accent))]/20 hover:border-[hsl(var(--fullsalud-accent))]/50 transition-all duration-300 hover:shadow-lg">
              <div className="mb-6">
                <span className="text-6xl font-bold text-[hsl(var(--fullsalud-accent))]">
                  2
                </span>
              </div>
              <h3 className="text-2xl font-semibold font-poppins mb-4 text-foreground">
            ...
            <Card className="text-center p-8 bg-white border border-[hsl(var(--fullsalud-green))]/20 hover:border-[hsl(var(--fullsalud-green))]/50 transition-all duration-300 hover:shadow-lg">
              <div className="mb-6">
                <span className="text-6xl font-bold text-[hsl(var(--fullsalud-green))]">
                  3
                </span>
              </div>
              <h3 className="text-2xl font-semibold font-poppins mb-4 text-foreground">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-2xl text-foreground mb-8 max-w-3xl mx-auto font-medium">
              Aumentá tu visibilidad y captá más pacientes con tu propio sitio
              web
            </p>
            <div className="mb-8">
            ...
            <Button
              size="lg"
              variant="default"
              className="text-xl px-14 py-8 font-bold shadow-xl transition-all hover:scale-105"
            >
              ...
              <div className="relative">
                <div className="bg-[hsl(var(--fullsalud-teal))] rounded-2xl p-8 text-white transform rotate-2 shadow-xl">
                  ...
                  <p className="opacity-90">
                    de los médicos reportan mayor eficiencia
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-muted-foreground mb-8">
                  Creamos landing pages profesionales diseñadas específicamente
                  para médicos. Atrae más pacientes y construye tu reputación
                  digital con un sitio web que refleje tu excelencia médica.
                </p>
                ...
                <div className="bg-gradient-hero rounded-2xl p-8 text-white transform -rotate-2 shadow-xl">
                  <div className="text-center">
                    ...
                    <p className="opacity-90 mb-4">
                      Ahorro en tareas administrativas
                    </p>
                    <div className="text-lg opacity-80">
                      "Ahora tengo más tiempo para mis pacientes y mi familia.
                      La automatización de turnos y recordatorios cambió
                      completamente mi rutina diaria"
                    </div>
                    <p className="text-sm opacity-70 mt-2">
                      - Dr. Roberto Fernández, Traumatólogo
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              Unite a los profesionales que ya están optimizando su práctica y
