    ...
    <footer className="w-full bg-white">
      ...
      <div
        className={`overflow-hidden transition-all duration-300 ease-in-out ${
          isExpanded
            ? "max-h-none md:max-h-[500px] opacity-100"
            : "max-h-0 opacity-0"
        }`}
      >
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-sm font-semibold text-fullsalud-charcoal mb-6">
                  Redes sociales
                </p>
              ...
              {/* Acerca de */}
              <div>
                <h3 className="font-semibold text-fullsalud-charcoal mb-4">
                  Acerca de
                </h3>
                <ul className="space-y-2 text-sm text-fullsalud-charcoal">
                  <li>
                    <a
                      href="#"
                      className="transition-colors hover:text-[#024A58] hover:underline"
                    >
                      Full Salud
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      className="transition-colors hover:text-[#024A58] hover:underline"
                    >
                      Especialistas que acepten tu obra social
                    </a>
                  </li>
                  <li>
                    <a
      ...
      <div
        ...
        style={{ borderColor: colors.dividerBorder + "99" }}
      />
      ...
      <div className="container mx-auto px-6 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-fullsalud-charcoal max-w-6xl mx-auto">
          <div className="flex flex-wrap justify-center md:justify-start gap-4">
            <a href="#" className="transition-colors hover:text-[#024A58] hover:underline">
              Quiénes somos
            </a>
